...
if(PYTHONINTERP_FOUND)
  ...
  if(__result MATCHES 0)
    ...
    if(NOT "${__ver_check}" STREQUAL "")
     ...
     unset(NUMPY_VERSION)
     unset(NUMPY_INCLUDE_DIR)
     message(FATAL_ERROR "Requested NumPy version and include path, but got instead:\n${__output}\n")
    endif()
  endif()
else()
  message(FATAL_ERROR "To find NumPy Python interpretator is required to be found.")
endif()